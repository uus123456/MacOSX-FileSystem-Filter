 ...
 */
{
    ...
    origVnop = (int (*)(struct vnop_lookup_args*))FltGetOriginalVnodeOp( ap->a_dvp, FltVopEnum_lookup );
    assert( origVnop );
 ...
 */
{
    ...
    origVnop = (int (*)(struct vnop_create_args*))FltGetOriginalVnodeOp( ap->a_dvp, FltVopEnum_create );
    assert( origVnop );
 ...
 */
{
    ...
    origVnop = (int (*)(struct vnop_close_args*))FltGetOriginalVnodeOp( ap->a_vp, FltVopEnum_close );
    assert( origVnop );
 ...
 */
{
    ...
    origVnop = (int (*)(struct vnop_inactive_args*))FltGetOriginalVnodeOp( ap->a_vp, FltVopEnum_inactive );
    assert( origVnop );
 ...
 */
{
    ...
    origVnop = (int (*)(struct vnop_read_args*))FltGetOriginalVnodeOp( ap->a_vp, FltVopEnum_read );
    assert( origVnop );
 ...
 */
{
    ...
    origVnop = (int (*)(struct vnop_open_args*))FltGetOriginalVnodeOp( ap->a_vp, FltVopEnum_open );
    assert( origVnop );
 ...
 */
{
    ...
    origVnop = (int (*)(struct vnop_write_args*))FltGetOriginalVnodeOp( ap->a_vp, FltVopEnum_write );
    assert( origVnop );
 ...
 */
{
    ...
    origVnop = (int (*)(struct vnop_pageout_args*))FltGetOriginalVnodeOp( ap->a_vp, FltVopEnum_pageout );
    assert( origVnop );
 ...
 */
{
    ...
    origVnop = (int (*)(struct vnop_rename_args*))FltGetOriginalVnodeOp( ap->a_fvp, FltVopEnum_rename );
    assert( origVnop );
    ...
    )
{
    ...
    origVnop = (int (*)(struct vnop_exchange_args*))FltGetOriginalVnodeOp( ap->a_fvp, FltVopEnum_exchange );
    assert( origVnop );
 ...
 */
{
    ...
    origVnop = (int (*)(struct vnop_reclaim_args*))FltGetOriginalVnodeOp( ap->a_vp, FltVopEnum_reclaim );
    assert( origVnop );
    ...
    //
    FltUnHookVnodeVopAndParent( ap->a_vp );
    return origVnop( ap );
}
