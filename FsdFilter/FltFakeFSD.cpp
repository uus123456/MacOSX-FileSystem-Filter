...
#define DLD_FAKE_FSD_NAME "FltFakeFsd"
...
FltVfsOperationDesc  gFltVfsOperationDesc[] = {
    ...
    { kFltVfsOpUnmount, DLD_VOP_UNKNOWN_OFFSET, (VFSFUNC)FltFakeFsdVfsUnmount },
    
    //
    // the terminating entry
    //
    { kFltVfsOpUnknown, DLD_VOP_UNKNOWN_OFFSET, (VFSFUNC)DLD_VOP_UNKNOWN_OFFSET }
};
        ...
        vfsOpPtr += 0x1 )
    {
        ...
        for( int i = 0x0; i < 50; ++i, ++vfsOpVector ){
            ...
            for( int k = 0x0; kFltVfsOpUnknown != gFltVfsOperationDesc[ k ].operation; ++k ){
                ...
                assert( DLD_VOP_UNKNOWN_OFFSET == gFltVfsOperationDesc[ k ].offset );
            ...
            for( int k = 0x0; kFltVfsOpUnknown != gFltVfsOperationDesc[ k ].operation; ++k ){
                ...
                if( *vfsOpVector != gFltVfsOperationDesc[ k ].sampleFunction ){
                    ...
                    //
                    continueSearch = ( DLD_VOP_UNKNOWN_OFFSET == gFltVfsOperationDesc[ k ].offset );
                    continue;
                }
